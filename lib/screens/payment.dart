          ...
          Container(
            decoration: BoxDecoration(
              image: DecorationImage(
                image: NetworkImage(
                    "https://images.pexels.com/photos/7966510/pexels-photo-7966510.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"),
                fit: BoxFit.cover,
              ),
            ),
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        ElevatedButton(
                            onPressed: () {}, child: Text("Cancel Ride"))
                      ],
                    ),
                    Divider(),
                    Row(
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: Image(
                            image: NetworkImage(
                                "https://www.flaticon.com/premium-icon/man_4140048"),
                          ),
                        ),
                        Column(
                          ...
                          children: [
                            Container(
                              ...
                              child: Image(
                                  fit: BoxFit.cover,
                                  image: NetworkImage(
                                      "https://cdn-icons.flaticon.com/png/128/1048/premium/1048316.png?token=exp=1656078483~hmac=b7441cfaf6128e23f0e2d5aac4e5df38")),
                            ),
                            Row(
                              children: [
                                Text("Toyota Vios-"),
                    ...
                    Row(
                        ...
                        children: [
                          ...
                          TextButton(onPressed: () {}, child: Text('Edit Ride'))
                        ]),
                    Stepper(
                      steps: [
                        Step(
                    ...
                    Row(
                      ...
                      children: [
                        ...
                        TextButton(onPressed: () {}, child: Text('Split cost'))
                      ],
                    ),
                    Text(
                      "US\$35.50",
